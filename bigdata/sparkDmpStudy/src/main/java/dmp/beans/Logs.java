...
public class Logs {
    ...
    public static Logs  line2Log (String line){
        if (StringUtils.isNotEmpty(line)){
            ...
            Logs logs = new Logs(
                    fields[0],
                    Utils.parseInt(fields[1]),
                    Utils.parseInt(fields[2]),
                    Utils.parseInt(fields[3]),
                    Utils.parseInt(fields[4]),
                    fields[5], fields[6],
                    Utils.parseInt(fields[7]), Utils.parseInt(fields[8]), Utils.parseDouble(fields[9]),
                    Utils.parseDouble(fields[10]),
                    fields[11], fields[12], fields[13], fields[14], fields[15], fields[16],
                    Utils.parseInt(fields[17]), fields[18], fields[19],
                    Utils.parseInt(fields[20]),
                    Utils.parseInt(fields[21]),
                    fields[22], fields[23], fields[24], fields[25],Utils.parseInt(fields[26]), fields[27],
                    Utils.parseInt(fields[28]), fields[29], Utils.parseInt(fields[30]),
